...
Usage
-----
>>> from ascent_load.loads_analysis.certification.report_docx import DocxReportWriter
...
>>> writer.generate("GACOMP_Cert_Report.docx")
"""
...
class DocxReportWriter:
    ...
    def _write_cover_page(self):
        ...
        p = self.doc.add_paragraph()
        p.alignment = WD_ALIGN_PARAGRAPH.CENTER
        run = p.add_run("GACOMP Light Aircraft")
        run.font.size = Pt(18)
        run.font.bold = True
        ...
        info_data = [
            ...
            ("Analysis Tool", "ASCENT-Load — Structural Analysis Framework"),
            ("Analysis Date",
    ...
    def _write_ch1_introduction(self):
        ...
        self.doc.add_paragraph(
            ...
            "analysis for the GACOMP light aircraft, performed in accordance "
        ...
        self.doc.add_paragraph(
            "The loads analysis was performed using the ASCENT-Load structural "
    ...
    def _write_ch2_aircraft(self):
        ...
        self._add_image("06_aircraft_model.png", width_inches=6.0,
                        caption="Figure 2-1. GACOMP Aircraft Configuration "
    ...
    def _write_ch3_theory(self):
        ...
        if wc:
            self.doc.add_paragraph(
                f"For the GACOMP at MTOW = {wc.weight_lb:.0f} lb:"
            )
    ...
    def _write_ch9_conclusions(self):
        ...
        summary = self.report.summary()
        self.doc.add_paragraph(
            "The FAA Part 23 certification loads analysis for the GACOMP "
    ...
    def generate(self, output_path: str = None) -> str:
        ...
        if output_path is None:
            ...
            output_path = f"GACOMP_Cert_Report_{ts}.docx"

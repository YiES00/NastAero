...
def plot_vn_diagram(vn_diagram, output_path: str = None,
    ...
    draw_vn_diagram(ax, vn_diagram, title=title)
    plt.tight_layout()
...
def draw_vn_diagram(ax, vn_diagram, title: str = None) -> None:
    """Draw a V-n diagram onto an existing Axes (no pyplot).

    Extracted from plot_vn_diagram so the same rendering can target an
    embedded Qt canvas.
    """
...
def plot_potato(potato_data, output_path: str = None,
    ...
    """
    fig, ax = plt.subplots(1, 1, figsize=figsize, dpi=dpi)
    draw_potato(ax, potato_data, title=title)
    plt.tight_layout()
...
def draw_potato(ax, potato_data, title: str = None) -> None:
    """Draw a potato diagram onto an existing Axes (no pyplot).

    Extracted from plot_potato so the same rendering can target an
    embedded Qt canvas.
    """
    cat_colors = {

#!/usr/bin/env python3
"""Run full certification loads analysis on GACOMP and print results."""
import os
import sys
import time
...
def main():
    ...
    # ---- 1. Parse GACOMP BDF ----
    print("=" * 70)
    print("GACOMP FAR Part 23 Certification Loads Analysis")
    print("=" * 70)
    ...
    try:
        ...
        viewer.plot_model(
            ...
            title="GACOMP Aircraft Configuration (FE + Aero Model)",
    ...
    docx_path = generate_cert_report(
        ...
        plot_dir=output_dir,
        vmt_data=vmt_data,
        output_path=os.path.join(output_dir, "GACOMP_Cert_Report.docx"),

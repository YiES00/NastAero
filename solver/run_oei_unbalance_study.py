#!/usr/bin/env python3
"""OEI Rotor Failure Unbalancing Study for GACOMP Lift+Cruise VTOL.
...
def main():
    ...
    print("  GACOMP Lift+Cruise VTOL Configuration")
    print("=" * 80)
    ...
    # ---- 1. Parse BDF + Setup ----
    model = parse_bdf("tests/validation/GACOMP/p400r3-free-trim.bdf")
    ...
    g = 9.80665
    wing_tip_y = 5.617  # GACOMP wing tip Y position in meters
    ...
    try:
        ...
        fig.suptitle(f'Worst-Case OEI Time History: {worst_oei["rotor_label"]} Failure\n'
                     f'GACOMP Hover, t_fail={t_fail:.1f}s',
                     fontsize=14, fontweight='bold')
